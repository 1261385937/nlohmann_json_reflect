...
struct sjson1 {
    ...
    std::tuple<std::optional<e1>, e2, e3> People;
...
int main() {
    ...
    sjson1 sjson1_data;
    sjson1_data.MixedArray = std::make_tuple("one", 50, false, 12.005f);
    sjson1_data.People = std::make_tuple(
        e1{ std::nullopt, 1000, true, 3.000f },
        e2{ "qq849635649", 10, false },
        e3{ "qq849635649", 20, true,"11" });
